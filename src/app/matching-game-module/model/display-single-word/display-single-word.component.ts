...
//   }
  ...
  // setRandomWords(categoryId: number, words: { origin: string; target: string }[]) {
  //   let originWordsArray : any = []
  //   let targetWordsArray : any = []
  //   words = this.categoriesService.getRandomWordsFromCategory(
  //     categoryId,
  //     5
  //   );
  //   originWordsArray = this.words
  //     .map((word) => word.origin)
  //     .sort(() => 0.5 - Math.random());
  //   targetWordsArray = this.words
  //     .map((word) => word.target)
  //     .sort(() => 0.5 - Math.random());

  //   return(targetWordsArray, originWordsArray)
  // }
